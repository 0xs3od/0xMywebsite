        ...
        <motion.div
          ...
          <div className="flex flex-wrap gap-2 mt-6">
            {tags.map((tag, i) =>
              <motion.span
                ...
                whileTap={{ scale: 0.95 }}
                className="px-3 py-1 rounded-md text-xs font-mono border border-border bg-secondary text-secondary-foreground tag-interactive magnetic-hover">
                {tag}
              </motion.span>
            )}
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-primary text-primary-foreground font-mono text-sm rounded-lg border-glow-red transition-colors">
              {">"} Contact_Me
            </motion.a>
            <motion.a
              href="#projects"
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 border border-border text-foreground font-mono text-sm rounded-lg hover:border-primary/40 transition-colors">
              {">"} View_Projects
            </motion.a>
          </motion.div>
        </motion.div>
