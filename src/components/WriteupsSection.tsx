    ...
    <section id="writeups" className="px-6 py-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.p
          ...
          Here I share some of my write-ups about technology and cybersecurity, reflecting ideas and experiences I have learned throughout my journey in this field.
        </motion.p>
